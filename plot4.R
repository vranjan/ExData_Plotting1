...
par(mfrow = c(2,2))
# (1,1)
plot(pow$datetime, as.numeric(as.character(pow$Global_active_power)),type="l",xlab="",ylab="Global Active Power")
# (1,2)
plot(pow$datetime, as.numeric(as.character(pow$Voltage)),type="l",xlab="datetime",ylab="Voltage")
...
# (2,2)
plot(pow$datetime, as.numeric(as.character(pow$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()